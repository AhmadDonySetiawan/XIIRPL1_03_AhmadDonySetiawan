...
Public Class RPT_Transaksi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LATIHAN.RPT_Transaksi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Transaksi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Transaksi = New RPT_Transaksi()
        rpt.Site = Me.Site
        Return rpt
    End Function
